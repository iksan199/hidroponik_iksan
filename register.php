          ...
          <div class="col-lg-12">
            <div class="p-5">
              <div class="text-center">
                <img src="img/5570.jpg" alt="Login" style="width:290px;height:180px;">
                <h1 class="h4 text-gray-900 mb-4">Create an Account to manage your Plants</h1>
              </div>
              <form class="user">
                ...
                <a href="refister.php" class="btn btn-primary btn-user btn-block">
                  Register Account
                </a>
              </form>
              <hr>
